use crate::models::{
    DetectedFaceOutput, ImageForm, ImageFormUtopia, RecognizedFaceOutput, TextQuery, VideoForm,
    VideoFormUtopia,
};
...
pub fn create_app(swagger_path: String, body_limit: u32, config: crate::config::Config) -> Router {
    ...
    #[openapi(
        ...
        components(
            schemas(ImageFormUtopia, DetectedFaceOutput, RecognizedFaceOutput, TextQuery, VideoFormUtopia)
        ),
        tags(
